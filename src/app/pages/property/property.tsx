...
const PropertyList: FC = () => {
    ...
    const mastersList = async() => {
        ...
        setPropertyStatus(response.output?.reverse());
    }
                                        ...
                                        <div className="row">
                                            <div className="col-xl-12">
                                                <div className="accordion" id="accordionPanelsStayOpenExample">
                                                    {propertyData.project_unit_type != null ? 
                                                    <div className="accordion-item border-0">
                                                        ...
                                                        <div id={"property_features"+propertyData.id} className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                                                            ...
                                                            {JSON.parse(propertyData.project_unit_type)?.map((unitData:any, index:any) => {
                                                            return (
                                                                <>
                                                                <div className="accordion-item px-xxl-4" key={index}>
                                                                    <p className="accordion-header d-flex justify-content-between fs-8" id={"headingTwo"}>
                                                                        ...
                                                                        <p className="mb-0 fs-8">{unitData.builtup_area_min_ut == '357' ? (unitData.builtup_area_min)+" "+ 'Acers' : unitData.builtup_area_min_ut == '355' ? (unitData.builtup_area_min)+" "+ 'Sq.ft' : unitData.builtup_area_min_ut == '356' ? (unitData.builtup_area_min)+" "+ 'Sq.mt' : '0' } - {unitData.builtup_area_max_ut == '357' ? (unitData.builtup_area_max)+" "+ 'Acers' : unitData.builtup_area_max_ut == '355' ? (unitData.builtup_area_max)+" "+ 'Sq.ft'  : unitData.builtup_area_max_ut == '356' ? (unitData.builtup_area_max)+" "+ 'Sq.mt' : '0' }</p>
                                                                    </p>
                                                                    <div id={"property_info"} className="accordion-collapse collapse" aria-labelledby={"headingTwo"} data-bs-parent="#property_accordion2">
                                                                        <div className="accordion-body px-0 py-2">
                                                                            ...
                                                                            {/* <p className='mb-0 fs-8'>{unitData.price_min}-{unitData.price_max} {unitData.local_currency}</p> */}
                                                                            <p className="mb-0 fs-8">{unitData.price_min_ut == 'crs' ? (unitData.price_min / 10000000) +' '+ 'C' : unitData.price_min_ut == 'lakhs' ? (unitData.price_min / 100000)  +' '+ 'L' : unitData.price_min_ut == 'thousand' ? (unitData.price_min / 1000) +' '+ 'K' : '0'} - {unitData.price_max_ut == 'crs' ? (unitData.price_max / 10000000) +' '+ 'C' : unitData.price_max_ut == 'lakhs' ? (unitData.price_max / 100000)  +' '+ 'L' : unitData.price_max_ut == 'thousand' ? (unitData.price_max / 1000) +' '+ 'K' : '0'}</p>
                                                                ...
                                                                {/* <div className="accordion-item px-xxl-4" key={index}>
                                                                    <p className="accordion-header d-flex justify-content-between fs-8" id={"headingTwo"+index+propertyData.id}>
                                                                        <button className="accordion-button collapsed fs-8" type="button" data-bs-toggle="collapse" data-bs-target={"#property_info"+index+propertyData.id} aria-expanded="false" aria-controls={"property_info"+index+propertyData.id}>
                                                                        <img src={toAbsoluteUrl('/media/custom/lead/bhk_4.svg')} className="svg_icon me-1" alt='' />
                                                                        <span className='fs-8'>{unitData.unit_type}</span>
                                                                        </button>
                                                                        <p className='mb-0 fs-8'>{unitData.builtup_area_min}-{unitData.builtup_area_max} Sqft</p>
