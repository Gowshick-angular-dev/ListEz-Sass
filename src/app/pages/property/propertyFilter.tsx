...
import { getPropertyFilter, getPropertyFilters, savePropertyFilter, getPropertyDropdowns, projectFilterDelete } from './core/_requests';
                ...
                <form noValidate onSubmit={formik.handleSubmit}>
                    <div className="row">
                            ...
                            {/* <FormControl sx={{ m: 0, width: '100%', mt: 0 }}>
                                <Select
                                    ...
                                    renderValue={(selected) => {
                                        ...
                                        if (selected.length === 0) {
                                        return <p>{intl.formatMessage({id: 'project_name'})}</p>;
                                        }
                                        return(
                                            <ul className='m-0'>
                                              {name?.map((data, i) => {
                                    ...
                                    >
                                    <MenuItem disabled value="">
                                        <em>{intl.formatMessage({id: 'project_name'})}</em>
                                    </MenuItem>
                                    {droplists.project?.map((Val:any) => (
                                        <MenuItem
                                        key={Val.id}
                                        value={Val.name_of_building+'-'+Val.id}
                                        style={getStyles(Val.name_of_building, projectName, theme)}
                                        >
                                        {Val.name_of_building}
                                        </MenuItem>
                                    ))}
                                </Select>
                            </FormControl> */}
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div className="input-group mb-3 bs_2 br_10">
                                {/* <select className="form-select bg-gray-100 border-0" {...formik.getFieldProps('property_source')}>
                                <option value=''>select</option>
                                    {droplists.property_source?.map((Data:any, i:any) => {
                                return(
                                    <option value={Data.id} key={i}>{Data.option_value}</option>
                                    )})}
                                </select> */}
                        ...
                        {/* <div className="col-md-6 col-12 mb-3">
                            ...
                            <div className="input-group mb-3 bs_2 br_10">
                                <select className="form-select bg-gray-100 border-0" {...formik.getFieldProps('segment')}>
                                <option value=''>select</option>
                                    {droplists.segment?.map((Data:any, i:any) => {
                                return(
                                    <option value={Data.id} key={i}>{Data.option_value}</option>
                                    )})}
                                </select>      
                        ...
                        <div className="col-md-6 col-12 mb-3">
                            ...
                            <div className="input-group mb-3 bs_2 br_10">
                                {/* <select className="form-select bg-gray-100 border-0" {...formik.getFieldProps('property_status')}>
                                    <option>All</option>
                                    <option value=''>select</option>
                                    {droplists.property_status?.map((Data:any, i:any) => {
                                return(
                                    <option value={Data.id} key={i}>{Data.option_value}</option>
                                    )})}
                                </select> */}
                        ...
                        {/* <div className="col-md-6 col-12 mb-3">
                            ...
                            <div className="input-group mb-3 bs_2 br_10">
                            <select className="form-select bg-gray-100 border-0" 
                            {...formik.getFieldProps('property')}
                            >
                                <option value=''>Select</option>
                                {droplists.property?.map((value:any,i:any)=> {
