...
const OrgMasters: FC = () => {
    ...
    const [masterList, setMastersList] = useState<any[]>(["age_of_property", "amenities", "attendance_status", "call_type", "category", "contact_status", "contact_type", "customer_language", "document_type", "expense_type", "fee_confirmation", "flooring", "furnishing_status", "gender", "invoice_status", "key_custody", "kitchen_type", "lead_drop_reason", "lead_group", "lead_lost_reason", "lead_status", "leave_type", "legal_approval", "marital_status", "nationality", "ownership_type", "payment_mode", "pets", "portal", "possession_status", "priority", "property_status", "property_type", "requirement_type", "site_visit_preference", "source", "task_status", "task_type", "unit_type", "vasthu_compliant", "water_supply", "property_indepth", "available_for", "segment", "department", "blood_group", "branch", "reminder", "task_priority", "contact_category", "phone_number_type", "contact_group", "do_not_disturb", "pet_owner", "id_documents", "country_code", "looking_for", "lead_priority", "lead_source", "project_facing", "requirement_location", "project_stage", "transaction_status", "fee_confirmation_status", "collection_status", "release_mode", "area_units", "plot_type", "type_of_building", "grade_of_building", "workstations_size", "conference_rooms_size", "pantry", "washrooms", "certifications", "coworking_type", "server_room", "office_work_hours", "industrial_type", "industrial_sub_type", "height_unit", "fire_safety", "age_of_structure", "property_situated_at", "property_situated_for", "visibility", "specification", "timeline_duration"]);
    ...
    const searchMaster = async(e:any) => {
      if(e) {
        const newPacientes = ["age_of_property", "amenities", "attendance_status", "call_type", "category", "contact_status", "contact_type", "customer_language", "document_type", "expense_type", "fee_confirmation", "flooring", "furnishing_status", "gender", "invoice_status", "key_custody", "kitchen_type", "lead_drop_reason", "lead_group", "lead_lost_reason", "lead_status", "leave_type", "legal_approval", "marital_status", "nationality", "ownership_type", "payment_mode", "pets", "portal", "possession_status", "priority", "property_status", "property_type", "site_visit_preference", "source", "task_status", "task_type", "unit_type", "vasthu_compliant", "water_supply", "property_indepth", "available_for", "segment", "department", "blood_group", "branch", "reminder", "task_priority", "contact_category", "phone_number_type", "contact_group", "do_not_disturb", "pet_owner", "id_documents", "country_code", "looking_for", "lead_priority", "lead_source", "project_facing", "requirement_location", "project_stage", "transaction_status", "fee_confirmation_status", "collection_status", "release_mode", "area_units", "plot_type", "Type_of_building", "grade_of_building", "workstations_size", "conference_rooms_size", "pantry", "washrooms", "certifications", "coworking_type", "server_room", "office_work_hours", "industrial_type", "industrial_sub_type", "height_unit", "fire_safety", "age_of_structure", "property_situated_at", "property_situated_for", "visibility", "specification", "timeline_duration"].filter(value => value.toLowerCase().replace('_', " ").replace('_', " ").includes(e.toLowerCase()));
        ...
        <div className='row masters_main h-100'>
            ...
            <div className={masterName ? 'col-md-6 col-lg-7 col-xl-8 col-xxl-9 ps-lg-2 ps-xl-4' : 'd-none d-md-block col-md-6 col-lg-7 col-xl-8 col-xxl-9 ps-lg-2 ps-xl-4'}>
                ...
                <div className="card h_85vh">
                        ...
                        <div className='card-toolbar align-items-start justify-content-end'>
                              <form noValidate onSubmit={formik.handleSubmit}>
                                  <div className='me-n3 d-flex align-items-center align-items-end'>
                                      ...
                                      <input type="text" max="25" className="form-control p-2 me-3" {...formik.getFieldProps('master_val')} onChange={(e) => formik.setFieldValue("master_val", e.target?.value.replace(/[^0-9a-zA-Z ]/g, ""))} />
                    ...
                    <div className="card-body p-7" id="pills-tabContent">
