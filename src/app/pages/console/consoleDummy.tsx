...
const Console: FC = () => {
    ...
    const statusWise = async () => {
        ...
        setContactProWise(response2?.output);
    ...
    const sourceWise = async () => {
        try {
            ...
            setContactProWise(response3?.output);
    ...
    const usersWise = async () => {
        ...
        setContactProWise(responseUserWise?.output);
    ...
    const leadProWise = async () => {
        ...
        setContactProWise(responseLeadSummary?.output);
    ...
    const leadStatusWise = async () => {
        ...
        setContactProWise(responseLeadStatus?.output);
    ...
    const leadSourceWise = async () => {
        ...
        setContactProWise(responseLeadSW?.output);
    ...
    const transactionProWise = async () => {
        ...
        setContactProWise(responseTransactionProW?.output);
    ...
    const transactionStatusWise = async () => {
        ...
        setContactProWise(responseTransactionStatusW?.output);
    ...
    const transactionSourceWise = async () => {
        ...
        setContactProWise(responseTransactionSourceW?.output);
    ...
    const dropProWise = async () => {
        ...
        setContactProWise(responseDropSummary?.output);
    ...
    const SiteVist = async () => {
        ...
        setContactProWise(responseSV?.output);
    ...
    const SiteVistSchedule = async () => {
        ...
        setContactProWise(responseSVSD?.output);
    ...
    const renderTableRows = () => {
        return siteVisitProjectWise.map((row, index) => {
            ...
            totalSchedule += parseInt(site_visit_schedule) || 0;
            totalCompleted += parseInt(site_visit_completed) || 0;
            totalCancelled += parseInt(site_visit_cancelled) || 0;
            ...
            return (
                <tr key={index} style={{ textAlign: 'center' }}>
                    ...
                    {Object.keys(rest).map((columnName, columnIndex) => {
                        if (
                            columnName !== 'property_id' &&
                            columnName !== 'property_name' &&
                            columnName !== 'site_visit_schedule' &&
    ...
    //     const aaa = [section1Ref?.current, section2Ref?.current]
    //     toPDF(aaa);
    // };
    ...
    return (
        <>
            ...
            <BlobProvider document={
                ...
                {({ blob }) => (
                    <div className="col-md-2 col-12 mb-3 d-flex align-items-center justify-content-end">
                    <button className='btn btn-primary mt-6' onClick={() => downloadPDF(blob)}>
                        Download PDF
                    </button>
                    </div>
                )}
            ...
            <div className=''>
                <div className='row'>
                    <div className='d-flex justify-content-center'>
                        <div className='col-md-3 w-100 my-4 mx-auto'>
                            <div className='card shadow-none rounded-0 w-100'>
                                <div className='card-body position-relative'>
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-md-2 col-12 mb-3 d-flex align-items-center justify-content-end">
                                            <button className='btn btn-primary mt-6' onClick={() => toPDF()}>
                                                Download PDF
                                            </button>
                                        </div>
                                    </div>
                ...
                <div className='' ref={targetRef}>
                    <div>
                        ...
                        {/* Total Count Summary */}
                        <h1 className='bg-warning p-4 my-4 text-center'>Total Count Summary</h1>
                        <div className="container pt-4 pb-4">
                            <div className="row p-2 px-0">
                                <div className="col-md-4">
                                    <div className="card bgGrey p-0">
                    ...
                    {/* Lead Summary */}
                    <div>
                        <h1 className='bg-warning p-4 my-4 text-center'>Lead Summary</h1>
                        <div className='row'>
                    ...
                    {/* Prospect Summary */}
                    <div>
                        <h1 className='bg-warning p-4 my-4 text-center'>Prospect Summary</h1>
                        <div className='row'>
                            <div className='col-md-3 w-50 my-4'>
                    ...
                    {/* Transaction Summary */}
                    <div>
                        <h1 className='bg-warning p-4 my-4 text-center'>Transaction Summary</h1>
                        <div className='row'>
                            <div className='col-md-3 w-50 my-4'>
                    ...
                    {/* Drop Summary */}
                    <div>
                        <h1 className='bg-warning p-4 my-4 text-center'>Drop Property Summary</h1>
                        <div className='row'>
                                ...
                                <table className="table bg-secondary">
                                    ...
                                    <tbody>
                                        {sourceEffi.map((row, i) => {
                                            ...
                                            totalContact1 += row.contact_generated;
                                            totalLead1 += row.lead_converted;
                                            totalBooking1 += row.booking;
                    ...
                    <div>
                        <h1 className='bg-warning p-4 my-4 text-center'>Project Wise Summary</h1>
                        <div className="row">
                            <div className="p-4 m-4 text-white">
                                <table className="table bg-secondary">
                                                ...
                                                {Object.keys(projectWise[0])
                                                    ...
                                                    .map((columnName) => (
                                                        <React.Fragment key={columnName}>
                                                            {columnName !== 'lead_converted' && columnName !== 'booking' && (
                                                                <th scope="col">{columnName}</th>
                                                            )}
                                                            {columnName === 'site_visit_count' && <th scope="col">Total Bookings</th>}
                                                        </React.Fragment>
                                                    ))}
                                            </tr>
                                        </thead>
                        ...
                        <h1 className='bg-warning p-4 my-4 text-center'>User Productivity</h1>
                        <div className='row'>
                    ...
                    {/* Site Visit */}
                    <div>
                        <h1 className='bg-warning p-4 my-4 text-center'>Site Visit Report</h1>
                        <div className="row">
                            <div className='col-md-3 w-50 my-4'>
                        ...
                        <h1 className='bg-warning p-4 my-4 text-center'>Project wise Site Visits Report</h1>
                        <div className='row'>
                            <div className="p-4 m-4 text-white bgGrey">
                                <table className="table bg-secondary">
                                    ...
                                    <tr className="bg-dark text-white" style={{ textAlign: 'center' }}>
                                        ...
                                        {Object.keys(totalColumnCounts).map((columnName, index) => (
                    ...
                    <h1 className='bg-warning p-4 my-4 text-center'>Project wise Site Visits Report List</h1>
                    <div className='row'>
