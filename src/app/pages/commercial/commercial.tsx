                                    ...
                                    <div className='mb-3'>
                                        <div className="row">
                                            <div className="col-xl-12">
                                                {propertyData.segment == '259' &&
                                                <div className="accordion" id="accordionPanelsStayOpenExample">
                                                    {propertyData.conventional_unit_type != null ? 
                                                    <div className="accordion-item border-0">
                                                        ...
                                                        <div id={"property_features"+propertyData.id} className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                                                            <div className="accordion property_accordion px-2 py-1" id="property_accordion2">
                                                                {JSON.parse(propertyData.conventional_unit_type)?.map((unitData:any, index:any) => {
                                                                    if(unitData.quoted_rent_price_min ||unitData.quoted_rent_price_max || unitData.escalation || unitData.security_deposit || unitData.lock_in) {
                                                                return (
                                                                <>
                                                                <div className="accordion-item px-xxl-4" key={index}>
                                                                    <p className="accordion-header d-flex justify-content-between fs-8" id={"headingTwo"}>
                                                                        ...
                                                                        <span className='fs-8'>quote ₹ {unitData.quoted_rent_price_min} - {unitData.quoted_rent_price_max}</span>
                                                                        </button>
                                                ...
                                                {propertyData.segment == '364' &&
                                                <div className="accordion" id="accordionPanelsStayOpenExample">
                                                    {propertyData.co_working_unit_type != null ? 
                                                    <div className="accordion-item border-0">
                                                        <p className="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button className="accordion-button collapsed py-2 px-xxl-5 px-md-4 px-3 text-dark fw-bold fs-8" type="button" data-bs-toggle="collapse" data-bs-target={"#property_features"+propertyData.id} aria-expanded="true" aria-controls={"property_features"+propertyData.id}>
                                                                {intl.formatMessage({id: 'project_features'})}
                                                        ...
                                                        <div id={"property_features"+propertyData.id} className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                                                            <div className="accordion property_accordion px-2 py-1" id="property_accordion2">
                                                                {JSON.parse(propertyData.co_working_unit_type)?.map((unitData:any, index:any) => {
                                                ...
                                                {propertyData.segment == '365' &&
                                                <div className="accordion" id="accordionPanelsStayOpenExample">
                                                    {propertyData.industrial_unit_type != null ? 
                                                    <div className="accordion-item border-0">
                                                        <p className="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button className="accordion-button collapsed py-2 px-xxl-5 px-md-4 px-3 text-dark fw-bold fs-8" type="button" data-bs-toggle="collapse" data-bs-target={"#property_features"+propertyData.id} aria-expanded="true" aria-controls={"property_features"+propertyData.id}>
                                                                {intl.formatMessage({id: 'project_features'})}
                                                        ...
                                                        <div id={"property_features"+propertyData.id} className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                                                            <div className="accordion property_accordion px-2 py-1" id="property_accordion2">
                                                                {JSON.parse(propertyData.industrial_unit_type)?.map((unitData:any, index:any) => {
                                                                    if(unitData.quoted_rent_price || unitData.escalation || unitData.security_deposit || unitData.lock_in) {
                                                                return (
                                                                <>
                                                                <div className="accordion-item px-xxl-4" key={index}>
                                                ...
                                                {propertyData.segment == '366' &&
                                                <div className="accordion" id="accordionPanelsStayOpenExample">
                                                    {propertyData.retail_unit_type != null ? 
                                                    <div className="accordion-item border-0">
                                                        <p className="accordion-header" id="panelsStayOpen-headingOne">
                                                            <button className="accordion-button collapsed py-2 px-xxl-5 px-md-4 px-3 text-dark fw-bold fs-8" type="button" data-bs-toggle="collapse" data-bs-target={"#property_features"+propertyData.id} aria-expanded="true" aria-controls={"property_features"+propertyData.id}>
                                                                {intl.formatMessage({id: 'project_features'})}
                                                        ...
                                                        <div id={"property_features"+propertyData.id} className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                                                            <div className="accordion property_accordion px-2 py-1" id="property_accordion2">
                                                                {JSON.parse(propertyData.retail_unit_type)?.map((unitData:any, index:any) => {
                                                                    if(unitData.quoted_rent_price || unitData.escalation || unitData.security_deposit || unitData.lock_in) {
                                                                return (
                                                                <>
                                                                <div className="accordion-item px-xxl-4" key={index}>
