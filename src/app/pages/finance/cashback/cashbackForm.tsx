...
import { getExpenses, getInvoice, saveCashback } from '../core/_requests';
...
import { getFinancePaymentMode } from '../../settings/masters/core/_requests';
...
const CashbackForm: FC<props> = (props) => {
    const intl = useIntl();
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, {setStatus, setSubmitting, resetForm}) => {
          ...
          try {
            ...
            const saveTaskData = await saveCashback(body);
            ...
            if(saveTaskData != null){
                setLoading(false);
                document.getElementById('kt_cashback_form_close')?.click();
    ...
    return(
        <div className='card shadow-none rounded-0 w-100'>
            <div className='card-header w-100' id='kt_proforma_header'>
                <h3 className='card-title fw-bolder text-dark'>{intl.formatMessage({id: 'add_cashback'})}</h3>
                <div className='card-toolbar'>
                    <button
                    type='button'
                    className='btn btn-sm btn-icon btn-active-light-primary me-n5'
                    id='kt_cashback_form_close'
                    >
                                    ...
                                    <div className="col-md-6 col-12 mb-3">
                                        ...
                                        <div className="input-group mb-3">
                                            <div className='autocomplete_field w-100'>
                                                ...
                                                // value={dropdowns.client_name?.filter((item:any) => selectedContacts?.indexOf(item) !== -1)}
