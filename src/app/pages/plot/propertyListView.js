...
const PropertyListView = (props) => {
    ...
    const {
        propertyListView, propertyStatus, propertyStatusChange, propertyId, formikNotes, cancelStatusChange, openModal
       } = props
    ...
    const columns = [
        ...
        { title: 'Features', field: 'project_unit_type', width: '500', render: rowData => 
        <div className='mb-3 w-300px'>
            <div className="row">
                <div className="col-xl-12">
                    <div className="accordion" id="accordionPanelsStayOpenExample">
                        {rowData.plot_unit_type != null ? 
                        <div className="accordion-item border-0">
                            ...
                            <div id={"property_features"+rowData.id} className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                                ...
                                {JSON.parse(rowData.plot_unit_type)?.map((unitData, index) => {
            ...
            document.getElementById('property_statusnkjkjb_rgkbjtyrtyrtyryrt'+rowData.id).value = rowData.property_status?.toString();
              ...
              {propertyStatus.map((statusVal,i) =>{
                  return (
                      ...
                      // <option value={statusVal.id} selected={statusVal.id == rowData.property_status} key={i}>{statusVal.option_value}</option> 
              )})}
          </select>
