...
import { getContactReports } from '../core/_request';
...
const ContactDoughnutReportSource: FC<Props> = (props) => {
  const intl = useIntl();
  const {
    ...
    const CountSourceList =  async (userId:any, body:any, team:any, title:any) => {   
      ...
      setListTitle("Contact Source Report " + ` (${userName})  (${body.filter == 1 ? 'Today' : body.filter == 2 ? 'Yesterday' : body.filter == 3 ? 'Last Week' : body.filter == 4 ? 'Last Month' : body.filter == 5 ? 'This Month' : body.filter == 6 ? 'This Year' : body.start_date +''+ body.end_date}) ` + "Generated On " + moment().format('DD-MM-YYYY'));
    }

    const rangeSelectPie = (val:any) => {
      if(val == 7) {
        document.getElementById('contactPieSourceDateRange')?.click();
      } else {
        setContactPie(val);
        var body = {
        'start_date': fromDate,
    ...
    const handleClick = async (event:any, chartElements:any) => {
        if (chartElements && chartElements.length > 0) {
            ...
            // const clickedValue = dataContact.datasets[0].data[dataIndex];  
            ...
            const response = await getContactReports(contactBody)
            setContacts(response.output);
            setListTitle("Contact Source Report - " + clickedLabel + ` (${userName})  (${contactPie == 1 ? 'Today' : contactPie == 2 ? 'Yesterday' : contactPie == 3 ? 'Last Week' : contactPie == 4 ? 'Last Month' : contactPie == 5 ? 'This Month' : contactPie == 6 ? 'This Year' : fromDate +''+ toDate}) ` + "Generated On " + moment().format('DD-MM-YYYY'));      
      };
    }
        ...
        datasets: [
          {
            label: '# of Votes',
            data: graphXContact,
            backgroundColor: [    '#e27e0c',    '#ff6700',    '#208ae6',    '#03a128',    '#f37485',    '#0c4688',    '#42a5f5',    '#fbc02d',    '#d32f2f',    '#7b1fa2',    '#43a047',    '#f06292',    '#1976d2',    '#ff5722',    '#8bc34a',    '#3f51b5',    '#e91e63',    '#ffc107',    '#c2185b',    '#4caf50',    '#9c27b0',    '#ff9800',    '#689f38',    '#673ab7',    '#ffeb3b',    '#388e3c',    '#9e9e9e',    '#cddc39',    '#0277bd',    '#ffeb3b',    '#8bc34a',    '#795548',    '#ffeb3b',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548',    '#795548']
            ,
    ...
    return(
        <>
        <div className='modal fade' id='contactPieChartSourceDate' data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden='true'>
        ...
        <div className="mx-sm-1 mx-xl-2 h-100">        
            <div className="card-heade border-0 d-flex align-items-center justify-content-end px-5">        
              ...
              {list == 1 ? <>
                ...
                <button type='button' data-bs-toggle='modal' data-bs-target='#contactPieChartSourceDate' className='d-none' id='contactPieSourceDateRange'>{intl.formatMessage({id: 'custom_date'})}</button>                
                </div>                
            </div>             
...
export {ContactDoughnutReportSource}