...
const ContactOverviewDoughnut: FC<Props> = (props) => {
  const intl = useIntl();
  const {
    data, users, teams
  } = props
    ...
    const rangeSelectPie = (val:any) => {
      if(val == 7) {
        document.getElementById('contactPieCustomDateRangeOverview')?.click();
      } else {
        setContactPie(val);
        var body = {
        'start_date': fromDate,
    ...
    return(
        <>
        <div className='modal fade' id='contactPieChartCustomDateOverview' data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden='true'>
            ...
            <div className="card-heade border-0 d-flex align-items-center justify-content-end pt-5 px-5">        
                ...
                <ul className="dropdown-menu db_dw_menu" aria-labelledby="selectDropdown">
                    ...
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'contact_type')}>{intl.formatMessage({id: 'contact_type'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'contact_category')}>{intl.formatMessage({id: 'contact_category'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'contact_status')}>{intl.formatMessage({id: 'contact_status'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'contact_group')}>{intl.formatMessage({id: 'contact_group'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                    ...
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'gender')}>{intl.formatMessage({id: 'gender'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'country')}>{intl.formatMessage({id: 'nationality'})}</li>
                      <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'property_id')}>{intl.formatMessage({id: 'project'})}</li>
                      <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'company_name')}>{intl.formatMessage({id: 'company_name'})}</li>
                      <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
              ...
              {list == 1 ? <>
                ...
                <button type='button' data-bs-toggle='modal' data-bs-target='#contactPieChartCustomDateOverview' className='d-none' id='contactPieCustomDateRangeOverview'>{intl.formatMessage({id: 'custom_date'})}</button>                
                </div>                
            </div>             
...
export {ContactOverviewDoughnut}