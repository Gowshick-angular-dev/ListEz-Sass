...
const TransactionDoughnutOverview2: FC<Props> = (props) => {
  const intl = useIntl();
  const {
    data, users, teams
  } = props
    ...
    const rangeSelectPie = (val:any) => {
      if(val == 7) {
        document.getElementById('transactionPieCustomDateRangeOverview2')?.click();
      } else {
        setContactPie(val);
        var body = {
        'start_date': fromDate,
    ...
    return(
        <>
        <div className='modal fade' id='transactionPieChartCustomDateOverview2' data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden='true'>
            ...
            <div className="card-heade border-0 d-flex align-items-center justify-content-end pt-5 px-5">        
                ...
                <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                    ...
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'lead_status')}>{intl.formatMessage({id: 'transaction_status'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                    ...
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'site_visit')}>{intl.formatMessage({id: 'site_visit'})}</li>  
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
              ...
              {list == 1 ? <>
                ...
                <button type='button' data-bs-toggle='modal' data-bs-target='#transactionPieChartCustomDateOverview2' className='d-none' id='transactionPieCustomDateRangeOverview2'>{intl.formatMessage({id: 'custom_date'})}</button>                
                </div>                
            </div>             
...
export {TransactionDoughnutOverview2}