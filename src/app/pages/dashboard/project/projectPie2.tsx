...
const PropertyDoughnut2: FC<Props> = (props) => {
  const intl = useIntl();
  const {
    data, users, teams
  } = props
    ...
    const rangeSelectPie = (val:any) => {
      if(val == 7) {
        document.getElementById('projectPieCustomDateRange2')?.click();
      } else {
        setContactPie(val);
        var body = {
        'start_date': fromDate,
    ...
    return(
        <>
        <div className='modal fade' id='projectPieChartCustomDate2' data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden='true'>
        ...
        <div className="card mx-sm-1 mx-xl-2 bs_1 h-100 br_15">
            <div className="card-heade border-0 d-flex align-items-center justify-content-end pt-5 px-5">        
                ...
                {/* <input className="form-select dash_btn m-2 fs-9" type="button" value={intl.formatMessage({id: title})} id="selectDropdown" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false"/>
                ...
                <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                    ...
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'property_status')}>{intl.formatMessage({id: 'property_status'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
              ...
              {list == 1 ? <>
                ...
                <button type='button' data-bs-toggle='modal' data-bs-target='#projectPieChartCustomDate2' className='d-none' id='projectPieCustomDateRange2'>{intl.formatMessage({id: 'custom_date'})}</button>                
                </div>                
            </div>             
