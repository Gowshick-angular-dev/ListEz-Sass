...
const TaskDoughnut: FC<Props> = (props) => {
  const intl = useIntl();
  const {
    data, users, teams
  } = props
    ...
    const rangeSelectPie = (val:any) => {
      if(val == 7) {
        document.getElementById('riuysfduyasfaurqfejqwhrqi6wetruwe')?.click();
      } else {
        setContactPie(val);
        var body = {
        'start_date': fromDate,
    ...
    return(
        <>
        <div className='modal fade' id='taskPieChartCustomDate' data-bs-backdrop="static" data-bs-keyboard="false" aria-hidden='true'>
            ...
            <div className="card-heade border-0 d-flex align-items-center justify-content-end pt-5 px-5">        
                ...
                <ul className="dropdown-menu db_dw_menu" aria-labelledby="selectDropdown">
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'priority')}>{intl.formatMessage({id: 'priority'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'project')}>{intl.formatMessage({id: 'project'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'task_status')}>{intl.formatMessage({id: 'task_status'})}</li>
                      <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                          'start_date': fromDate,
                          'end_date': toDate,
                          'filter': contactPie,
                        }, teamId, 'task_type')}>{intl.formatMessage({id: 'task_type'})}</li>
                    <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                    ...
                    {/* <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        ...
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'group')}>{intl.formatMessage({id: 'group'})}</li> */}
                      {/* <li className="dropdown-item cursor-pointer" onClick={() => CountSourceList(reqId, {
                        'start_date': fromDate,
                        'end_date': toDate,
                        'filter': contactPie,
                      }, teamId, 'overdue')}>{intl.formatMessage({id: 'overdue'})}</li> */}
                </ul>
                {roleId != 4 && <>
              ...
              {list == 1 ? <>
                ...
                <button type='button' data-bs-toggle='modal' data-bs-target='#taskPieChartCustomDate' className='d-none' id='riuysfduyasfaurqfejqwhrqi6wetruwe'>{intl.formatMessage({id: 'custom_date'})}</button>                
                </div>                
            </div>             
